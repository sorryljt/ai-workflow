...
- P24：review 将源码缺回归测试视为 BLOCKING，S 档同样适用；只有 plan.md 对对应 AC 明确说明替代验证及理由才可免测。spawn 按本轮审查范围提示缺测试，覆盖首次审查与复审。
- P25：AGENTS.md 注入对话输出纪律、待确认卡和需要处理卡，skills 原文不变；安装测试核对模板完整性。
